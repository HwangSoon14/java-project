...
public class Issue_Book {
    ...
    public void addIssue(int idChungNhan, int idCuaHang, String ngayCap, String ngayHuy) throws SQLException {
        String insertQuery = "INSERT INTO `cap_chungnhan`(`ID_CH`, `ID_CN`, `NgayCapCN`, `NgayThuHoiCN`) VALUES ( ?, ?, ?, ?)";
        try {
